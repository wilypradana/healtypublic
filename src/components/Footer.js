export default function Footer() {
  return (
    <>
      <footer class="bg-[#e6e6e6] pt-4" id="contact">
          ...
          <div class="lg:flex lg:items-start lg:gap-8">
            ...
            <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              <div class="col-span-2">
                <div>
                  <h1 class="text-4xl text-black font-bold">healthwisehive</h1>

                  <p class="mt-4 text-black font-primary font-extrabold text-sm">
                    SIGN UP TO RECEIVE EXCLUSIVE OFFERS AND DISCOUNTS
                  </p>
                </div>
              </div>
              <div class="col-span-2 sm:col-span-1">
                <ul class="mt-6 space-y-4 text-sm font-primary">
                  <li>
                    <a
              ...
              <div class="col-span-2 sm:col-span-1">
                <ul class="mt-6 space-y-4 text-md font-bold font-primary">
                  <li>
                    <a
                      href="as"
                      class="text-gray-700 transition hover:opacity-75"
          ...
          <div class="mt-8 border-t border-gray-500 pt-8">
            <div class="sm:flex sm:justify-between">
              <p class="text-xs text-gray-500">
                &copy; 2023. WiseHive. All rights reserved.
              </p>
